  ...
  return (
    <div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p
          className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-2xl">
          Join us for three days of innovation, learning, and competition at Tech Habba 2024. Experience the future of AI technology.
        </p>
      </div>
