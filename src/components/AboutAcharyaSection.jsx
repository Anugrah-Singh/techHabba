...
const AboutAcharyaSection = () => {
  return (
    <div
      id="about-acharya"
      className="scroll-mt-40 py-16 px-4 sm:px-6 lg:px-8 dark:bg-black"
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          <div className="bg-white dark:bg-gray-900 p-4 md:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            <h3 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4 text-blue-600 dark:text-white">Vision</h3>
          ...
          <div className="bg-white dark:bg-gray-900 p-4 md:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            <h3 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4 text-blue-600 dark:text-white">Mission</h3>
            <p className="text-sm md:text-base text-gray-700 dark:text-gray-300">
              To provide excellent academic ambience, foster development, and ensure ethical, sustainable service.
            </p>
          </div>

          <div className="bg-white dark:bg-gray-900 p-4 md:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 md:col-span-2 lg:col-span-1">
            <h3 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4 text-blue-600 dark:text-white">Motto</h3>
